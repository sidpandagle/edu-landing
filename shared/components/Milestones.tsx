    ...
    return (
        <section className="bg-white pt-4 lg:pt-8"  id="milestones">
            ...
            <div className="flex gap-8 flex-col p-8 md:p-4 md:flex-row justify-between mx-auto max-w-screen-lg">
                ...
                <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                    <Image src="/people/Job Oriented Training.jpg" className="designer" alt="designer" height={100} width={700}/>
                    <div className="p-4">
                ...
                <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                    <Image src="/people/Work on Real Projects.jpg" className="designer" alt="designer" height={100} width={700}/>
                    <div className="p-4">
            ...
            <div className="flex gap-8 flex-col p-8 md:p-4 md:flex-row justify-between mx-auto max-w-screen-lg">
                <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                    <Image src="/people/Internship from corporate connect.jpg" className="designer" alt="designer" height={100} width={700}/>
                    <div className="p-4">
                ...
                <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                    <Image src="/people/Full Time Employability.jpg" className="designer" alt="designer" height={100} width={700}/>
                    <div className="p-4">
                ...
                <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                    <Image src="/people/Personalized_Men.jpg" className="designer" alt="designer" height={100} width={700}/>
                    <div className="p-4">
