        ...
        <div className="bg-white">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm">
                    <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 ">Projects</h2>
                    ...
                    <div className="container px-6 mx-auto">
                        <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-1 xl:grid-cols-1">
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Healthcare - Predictive Analytics for Disease Diagnosis</h2>
                                    </div>
                                </div>
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Finance - Fraud Detection in Financial Transactions</h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">E-commerce - Product Recommendation Engine</h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Retail - Sales Forecasting for Inventory Management</h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Marketing - Customer Churn Prediction</h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Human Resources - Resume Screening and Candidate Matching </h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
                            ...
                            <div className="p-4 border rounded-lg flex flex-col justify-between shadow-md">
                                <div className="-mx-2">
                                    <div className="mx-2 text-left">
                                        <h2 className="font-semibold text-gray-800 ">Customer Service - Chatbot for Automated Customer Support </h2>
                                    </div>
                                </div>
                                <p className="leading-loose text-gray-500 text-left text-sm ">
