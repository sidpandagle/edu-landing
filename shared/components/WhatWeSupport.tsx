            ...
            <div className=" flex gap-8 md:flex-row items-center justify-center text-neutral py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-12">
                <div className="flex gap-8 flex-col md:flex-row justify-between">
                    <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                        <Image src="/people/guaranteed.jpg" className="object-cover h-48 w-full object-top" alt="guaranteed" height={100} width={400} />
                        <div className="p-4">
                            <div className="text-lg text-black pb-2 font-semibold">100% Guaranteed Internship </div>
                            <div className="text-sm text-slate-600">Secure your future with our data science and business analytics course in Pune. Every participant gets a 100% guaranteed internship, offering hands-on experience and a path to becoming a data scientist. Connect with industry people and gain practical knowledge.
                    ...
                    <div className="rounded-md border overflow-hidden shadow-md md:w-1/3">
                        <Image src="/people/learner.jpg" className="object-cover h-48 w-full object-top" alt="learner" height={100} width={400} />
                        <div className="p-4">
